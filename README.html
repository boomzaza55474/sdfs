...
<body>
    ...
    <nav>
        ...
        <div class="nav-เข้าสู่ระบบด้วย">
            <p><a style="color:black;">เข้าสู่ระบบด้วย</p></a>    
        <a href="login.html">
            <p><a href="https://www.facebook.com/?ref=tn_tnmn"><img src="Facebook_Logo_(2019).png" class="nav-fb"></p>
        </a> 
        <a href="login.html">
            <p><a href="https://accounts.google.com/InteractiveLogin/identifier?continue=https%3A%2F%2Fwww.google.co.th%2F&ec=GAZAmgQ&hl=th&passive=true&ifkv=AWnogHflnrUzYR9VGFJPNxqayMj6sjGJHJ1nNhJSMPYnBMekKvEmZ01x7kqaPpcuqTJTgp_FKDqd6Q&flowName=GlifWebSignIn&flowEntry=ServiceLogin"><img src="Google-Logo-PNG-HD-Quality.png" class="nav-go"></p>
        </a> 
        <a href="login.html">
           <p><a href="https://twitter.com/i/flow/login"><img src="pngtree-twitter-social-media-round-icon-png-image_6315985.png" class="nav-tw"></p>
        </a> 
